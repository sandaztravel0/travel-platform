...
const EMPTY_FORM = { name: '', district: '', description: '', category: '', best_time: '', things_to_do: '', video_url: '', latitude: '', longitude: '', image_urls: [] };
...
export default function AdminLocations() {
  ...
  const handleEdit = (loc) => {
    setForm({
      ...
      category: loc.category || '', best_time: loc.best_time || '', things_to_do: loc.things_to_do || '', video_url: loc.video_url || '',
      ...
      <div style={styles.layout}>
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <textarea
            ...
            name="things_to_do"
            placeholder={'Things to do — one per line, e.g.\nClimb the rock fortress at sunrise\nWalk through the water gardens'}
            value={form.things_to_do}
            onChange={handleChange}
          />
          <input style={styles.input} name="video_url" placeholder="Video URL (optional, e.g. a YouTube link)" value={form.video_url} onChange={handleChange} />
